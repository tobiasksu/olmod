...
namespace GameMod.Weapons
{
    public class Reflex : IWeapon
    {
        public void Fire(Player player, float refire_multiplier)
        {
            ...
            {
                ProjectileManager.PlayerFire(player, type, player.c_player_ship.m_muzzle_right.position, player.c_player_ship.c_transform.localRotation, 0f, player.m_weapon_level[(int)player.m_weapon_type], false, 0);
            }
            else
            {
                ProjectileManager.PlayerFire(player, type, player.c_player_ship.m_muzzle_left.position, player.c_player_ship.c_transform.localRotation, 0f, player.m_weapon_level[(int)player.m_weapon_type], false, 1);
            }
