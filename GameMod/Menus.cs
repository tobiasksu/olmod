...
namespace GameMod
{
    public static class Menus
    {
        ...
        public static string GetMMSCtfBoost()
        {
    ...
    class Menus_UIElement_DrawMpMatchSetup
    {
        ...
        private static void DrawRightColumn(UIElement uie, ref Vector2 position)
        {
            ...
            position.y += 62f;
            uie.SelectAndDrawStringOptionItem(Loc.LS("CTF CARRIER BOOSTING"), position, 14, Menus.GetMMSCtfBoost(), Loc.LS("FLAG CARRIER CAN USE BOOST IN CTF"), 1f, false);
            position.y += 62f;
        }
